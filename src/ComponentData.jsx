// ComponentData.js - Updated with 4-digit IDs from 1000-9999
export const componentData = [
    { id: 'social-1501', type: 'social', label: 'Minimal Social Icons', targetSection: 'social', icon: '👥', variant: 'minimal', imagePath: '/images/social/social-icons-minimal.png' },
    ...
    { id: 'faq-1403', type: 'faq', label: 'Grid FAQ', targetSection: 'faq', icon: '❓', variant: 'grid', imagePath: '/images/faq/faq-grid.png' },
    { id: 'newsletter-1603', type: 'newsletter', label: 'Inline Newsletter', targetSection: 'newsletter', icon: '📮', variant: 'inline', imagePath: '/images/newsletter/newsletter-inline.png' },
    { id: 'testimonials-1102', type: 'testimonials', label: 'Testimonials Grid', targetSection: 'testimonials', icon: '💬', variant: 'grid', imagePath: '/images/testimonials/testimonials-grid.png' },
    ...
    { id: 'gallery-1301', type: 'gallery', label: 'Grid Gallery', targetSection: 'gallery', icon: '🖼️', variant: 'grid', imagePath: '/images/gallery/gallery-grid.png' },
    { id: 'team-1701', type: 'team', label: 'Team Grid', targetSection: 'team', icon: '👥', variant: 'grid', imagePath: '/images/team/team-grid.png' },
    { id: 'subscription-1201', type: 'subscription', label: 'Dark Subscription Form', targetSection: 'subscription', icon: '📧', variant: 'dark', imagePath: '/images/subscription/subscription-dark.png' },
    { id: 'cta-9001', type: 'cta', label: 'Blue CTA Button', targetSection: 'cta', icon: '🔘', variant: 'blue', imagePath: '/images/cta/cta-blue.png' },
    { id: 'pricing-1101', type: 'pricing', label: 'Standard Pricing Table', targetSection: 'pricing', icon: '💰', variant: 'standard', imagePath: '/images/pricing/pricing-standard.png' },
    ...
    { id: 'team-1703', type: 'team', label: 'Team List', targetSection: 'team', icon: '👥', variant: 'list', imagePath: '/images/team/team-list.png' },
    { id: 'gallery-1303', type: 'gallery', label: 'Masonry Gallery', targetSection: 'gallery', icon: '🖼️', variant: 'masonry', imagePath: '/images/gallery/gallery-masonry.png' },
    ...
    { id: 'testimonials-1103', type: 'testimonials', label: 'Single Testimonial', targetSection: 'testimonials', icon: '💬', variant: 'single', imagePath: '/images/testimonials/testimonials-single.png' },
    ...
    { id: 'faq-1402', type: 'faq', label: 'List FAQ', targetSection: 'faq', icon: '❓', variant: 'list', imagePath: '/images/faq/faq-list.png' },
    ...
    { id: 'subscription-1202', type: 'subscription', label: 'Light Subscription Form', targetSection: 'subscription', icon: '📧', variant: 'light', imagePath: '/images/subscription/subscription-light.png' },
    { id: 'team-1702', type: 'team', label: 'Team Carousel', targetSection: 'team', icon: '👥', variant: 'carousel', imagePath: '/images/team/team-carousel.png' },
    ...
    { id: 'social-1502', type: 'social', label: 'Colored Social Icons', targetSection: 'social', icon: '👥', variant: 'colored', imagePath: '/images/social/social-icons-colored.png' },
    { id: 'newsletter-1601', type: 'newsletter', label: 'Simple Newsletter', targetSection: 'newsletter', icon: '📮', variant: 'simple', imagePath: '/images/newsletter/newsletter-simple.png' },
    { id: 'pricing-1003', type: 'pricing', label: 'Dark Mode Pricing Table', targetSection: 'pricing', icon: '💰', variant: 'dark', imagePath: '/images/pricing/pricing-dark.png' },
    ...
    { id: 'gallery-1302', type: 'gallery', label: 'Carousel Gallery', targetSection: 'gallery', icon: '🖼️', variant: 'carousel', imagePath: '/images/gallery/gallery-carousel.png' },
    { id: 'testimonials-1101', type: 'testimonials', label: 'Testimonials Carousel', targetSection: 'testimonials', icon: '💬', variant: 'carousel', imagePath: '/images/testimonials/testimonials-carousel.png' },
    { id: 'subscription-1203', type: 'subscription', label: 'Bordered Subscription Form', targetSection: 'subscription', icon: '📧', variant: 'bordered', imagePath: '/images/subscription/subscription-bordered.png' },
    ...
    { id: 'social-1503', type: 'social', label: 'Black Social Icons', targetSection: 'social', icon: '👥', variant: 'black', imagePath: '/images/social/social-icons-black.png' },
    ...
    { id: 'newsletter-1602', type: 'newsletter', label: 'Popup Newsletter', targetSection: 'newsletter', icon: '📮', variant: 'popup', imagePath: '/images/newsletter/newsletter-popup.png' },
    { id: 'pricing-1002', type: 'pricing', label: 'Highlighted Pricing Table', targetSection: 'pricing', icon: '💰', variant: 'highlighted', imagePath: '/images/pricing/pricing-highlighted.png' },
    ...
    { id: 'faq-1401', type: 'faq', label: 'Accordion FAQ', targetSection: 'faq', icon: '❓', variant: 'accordion', imagePath: '/images/faq/faq-accordion.png' },
