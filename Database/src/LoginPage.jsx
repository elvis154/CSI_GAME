          ...
          <div className="win95-box">
            <div className="win95-titlebar">
              <div className="titlebar-left">
                <img src="/images/windows.png" alt="Win95" className="win95-icon" />
            ...
            <div className="win95-content">
              <div className="login-header">
                <div className="login-icon-container">
                  <img src="/images/padlock.png" alt="Login" className="login-icon pulse" />
                </div>
                <h2 className="welcome-text">Welcome to Ghost Protocol Level 2</h2>
              </div>
              <div className="user-profile">
                <div className="user-avatar">
                  <img src="/images/csi-logo.png" alt="User" className="avatar-img" />
                </div>
